...
private CommandeItemConverter commandeItemConverter;
    ...
    public List<CommandeItemVo> findByCriteria(@RequestBody CommandeItemVo commandeItemVo){
        ...
        return commandeItemService.deleteByCommandeId(id);
            ...
            @PutMapping("/archiver/")
            public CommandeItemVo archiver(@RequestBody CommandeItemVo commandeItemVo){
                CommandeItem commandeItem = commandeItemService.archiver(commandeItemConverter.toItem(commandeItemVo));
                return commandeItemConverter.toVo(commandeItem);
                }

            @PutMapping("/desarchiver/")
            public CommandeItemVo desarchiver(@RequestBody CommandeItemVo commandeItemVo){
                CommandeItem commandeItem = commandeItemService.desarchiver(commandeItemConverter.toItem(commandeItemVo));
                return commandeItemConverter.toVo(commandeItem);}
            }
