...
private ClientConverter clientConverter;
    ...
    public List<ClientVo> findByCriteria(@RequestBody ClientVo clientVo){
        return clientConverter.toVo(clientService.findByCriteria(clientVo));
            ...
            @PutMapping("/archiver/")
            public ClientVo archiver(@RequestBody ClientVo clientVo){
                Client client = clientService.archiver(clientConverter.toItem(clientVo));
                return clientConverter.toVo(client);
                }

            @PutMapping("/desarchiver/")
            public ClientVo desarchiver(@RequestBody ClientVo clientVo){
                Client client = clientService.desarchiver(clientConverter.toItem(clientVo));
                return clientConverter.toVo(client);}
            }
