...
private CommandeTagConverter commandeTagConverter;
    ...
    public List<CommandeTagVo> findByCriteria(@RequestBody CommandeTagVo commandeTagVo){
        ...
        return commandeTagService.deleteByTagId(id);
            ...
            @PutMapping("/archiver/")
            public CommandeTagVo archiver(@RequestBody CommandeTagVo commandeTagVo){
                CommandeTag commandeTag = commandeTagService.archiver(commandeTagConverter.toItem(commandeTagVo));
                return commandeTagConverter.toVo(commandeTag);
                }

            @PutMapping("/desarchiver/")
            public CommandeTagVo desarchiver(@RequestBody CommandeTagVo commandeTagVo){
                CommandeTag commandeTag = commandeTagService.desarchiver(commandeTagConverter.toItem(commandeTagVo));
                return commandeTagConverter.toVo(commandeTag);}
            }
