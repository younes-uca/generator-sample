...
private PaiementConverter paiementConverter;
    ...
    public List<PaiementVo> findByCriteria(@RequestBody PaiementVo paiementVo){
        ...
        return paiementService.deleteByCommandeId(id);
            ...
            @PutMapping("/archiver/")
            public PaiementVo archiver(@RequestBody PaiementVo paiementVo){
                Paiement paiement = paiementService.archiver(paiementConverter.toItem(paiementVo));
                return paiementConverter.toVo(paiement);
                }

            @PutMapping("/desarchiver/")
            public PaiementVo desarchiver(@RequestBody PaiementVo paiementVo){
                Paiement paiement = paiementService.desarchiver(paiementConverter.toItem(paiementVo));
                return paiementConverter.toVo(paiement);}
            }
